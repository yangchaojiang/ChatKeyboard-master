...
import com.yang.keyboard.view.SoftListenLayout;
/**
...
public class EmoticonsPageView extends ViewPager implements IView {
    ...
    private void updateView() {
        ...
        if (mOnEmoticonsPageViewListener!=null) {
            mOnEmoticonsPageViewListener.emoticonsPageViewCountChanged(getPageCount(mEmoticonSetBeanList.get(0)));
        }
    }
        ...
        public void onPageSelected(int position) {
            ...
            for ( EmoticonSetBean emoticonSetBean : mEmoticonSetBeanList ) {
                ...
                if ( end + size > position ) {
                    ...
                    mOnEmoticonsPageViewListener.moveBy(mOldPagePosition, position - end);
                    break;
                }
                pagerPosition++;
                end += size;
