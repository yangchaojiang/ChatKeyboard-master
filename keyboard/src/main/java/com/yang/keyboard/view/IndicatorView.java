...
public class IndicatorView extends LinearLayout {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        bmpSelect = ContextCompat.getDrawable(mContext, android.R.drawable.presence_online);
        bmpNormal = ContextCompat.getDrawable(mContext, android.R.drawable.presence_invisible);
